...
//   download the real product photos from dba.hk into that folder using these exact filenames
...
//
// Product names, capacities and specs below were taken from dba.hk. Prices intentionally omitted —
...
export interface Product {
  ...
  sourceUrl: string;       // original dba.hk product page (for scraping images/specs)
...
export const contact = {
  whatsapp: "85254880850",           // wa.me number, no + or spaces
    ...
    products: [
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-utc20-ultra-thin-ceiling-dehumidifier",
      ...
      },
      {
        ...
        description:
          "A high-capacity ultra-thin ceiling dehumidifier built for medium to large commercial spaces. Serious dehumidification power in a slim, unobtrusive form. A single unit keeps a typical Hong Kong flat below 60% RH.",
        bestFor: ["residential", "commercial"],
        ...
        sourceUrl: "https://www.dba.hk/products/dba-utc68-ultra-thin-ceiling-dehumidifier",
      ...
      },
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-utc120-ultra-thin-ceiling-dehumidifier",
    ...
    products: [
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-gec68ld-hp-ceiling-dehumidifier",
      ...
      },
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-gec145ld-hp-industrial-dehumidifier",
      ...
      },
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-gec280ld-ceiling-dehumidifier",
      ...
      },
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-gec400ld-ceiling-dehumidifier",
      ...
      },
      {
        ...
        sourceUrl: "https://www.dba.hk/products/dba-gec550ld-ceiling-dehumidifier",
